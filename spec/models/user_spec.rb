...
describe User do
  before do
    @user = User.new(name: 'Omuko', email: 'omuco@example.com', password: 'foobar', password_confirmation: 'foobar')
  end
  subject { @user }
  ...
  describe "when password is not present" do
    before do
      @user = User.new(name: 'Omuko', email: 'omuco@example.com', password: ' ', password_confirmation: ' ')
    end
    it { should_not be_valid }
  end
  ...
  describe "return calue of authenticate method" do
    before { @user.save }
  ...
  describe "relationship associations" do
    ...
    let!(:user_followed) do
      FactoryGirl.create(:relationship, follower: @user, followed: followed_user)
    end
    let!(:user_follower) do
      FactoryGirl.create(:relationship, follower: follower_user, followed: @user)
    end
  ...
  describe "micropost associations" do
    ...
    it "should have the right microposts int the right order" do
